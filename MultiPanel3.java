...
public class MultiPanel3 extends JPanel
{
     ...
     public MultiPanel3(Color _backgroundColor, Color _squareColor)
     {
          super();
     ...
     public void paintComponent(Graphics g)
     {
          ...
          g.fillRect(400,0,200, getHeight());
