...
/////////////////////////////////////////////////////////////////////////////////
    ...
    public int find(int k)
    {
    	...
    	else
    	{
    		...
    		while(l < size)
    		{
    			...
    			else if(head.next.getKey() == k)
    			{
    				Link newHead = head.next;
    				head.next = newHead.next;
    				newHead.next.before = head;
    				newHead.next = head;
    				head.before = newHead;
    				newHead.before = tail;
    				tail.next = newHead;
    			...
    			else if(tail.getKey() == k)
    			{
    				...
    				newTail.before.next = tail;
    				tail.before = newTail.before;
    				tail.next = newTail;
    				newTail.before = tail;
    				newTail.next = head;
    				head.before = newTail;
    			...
    			else if(pos.getKey() == k)
    			{
    				...
    				Link newPos = pos.before;
    				newPos.before.next = pos;
    				pos.before = newPos.before;
    				newPos.next = pos.next;
    				pos.next.before = newPos;
    				pos.next = newPos;
    				newPos.before = pos;
    				return number_comparisons+=l;
    			}
    ...
    public static void getFile(Transpose dictionary)
    {
    	try
        {
        	Scanner fileInput = new Scanner(new File("Uniform-large.dat"));
    ...
    public static void processLine(String line, Transpose dictionary)
    {
    ...
    {
        Transpose dictionary = new Transpose();      
        getFile(dictionary); 
